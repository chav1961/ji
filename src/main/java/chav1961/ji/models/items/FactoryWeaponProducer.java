...
public class FactoryWeaponProducer implements Actor {
	private static final AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.IRON, 2),
	...
	public String toString() {
		return "FactoryWeaponProducer [awaited=" + awaited + "]";
	}
}
