...
public class OreCollector implements Actor {
	private static AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.ORE, 1),
	...
	public String toString() {
		return "OreCollector [awaited=" + awaited + "]";
	}
}
