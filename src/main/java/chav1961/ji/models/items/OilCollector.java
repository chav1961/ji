...
public class OilCollector implements Actor {
	private static AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.OIL, 1),
	...
	public String toString() {
		return "OilCollector [awaited=" + awaited + "]";
	}
}
