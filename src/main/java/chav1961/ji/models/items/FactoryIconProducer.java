...
public class FactoryIconProducer implements Actor {
	private static final AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.ORE, 1),
														new AncestorSourceImpl(GoodsType.COAL, 1),
	...
	public String toString() {
		return "FactoryIronProducer [awaited=" + awaited + "]";
	}
}
