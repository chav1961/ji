...
public class FactoryFurnitureProducer implements Actor {
	private static final AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.WOOD, 2),
	...
	public String toString() {
		return "FactoryFurnitureProducer [awaited=" + awaited + "]";
	}
}
