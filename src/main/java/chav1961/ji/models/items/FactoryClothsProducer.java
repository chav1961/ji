...
public class FactoryClothsProducer implements Actor {
	private static final AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.COTTON, 2),
	...
	public String toString() {
		return "FactoryClothsProducer [awaited=" + awaited + "]";
	}
}
