...
public class FurnitureCollector implements Actor {
	private static AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.FURNITURE, 1),
												 new AncestorSourceImpl(GoodsType.RAILWAY, 1)
												};

	private int	awaited = 0;

	public FurnitureCollector() {
	}
	...
	public String toString() {
		return "FurnitureCollector [awaited=" + awaited + "]";
	}
}
