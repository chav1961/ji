...
public class WeaponCollector implements Actor {
	private static AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.WEAPON, 1),
	...
	public String toString() {
		return "WeaponCollector [awaited=" + awaited + "]";
	}
}
