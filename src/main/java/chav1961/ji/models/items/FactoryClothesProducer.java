...
public class FactoryClothesProducer implements Actor {
	private static final AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.CLOTH, 2),
	...
	public String toString() {
		return "FactoryClothesProducer [awaited=" + awaited + "]";
	}
}
