...
public class FruitsCollector implements Actor {
	private static AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.FRUITS, 1),
	...
	public String toString() {
		return "FruitsCollector [awaited=" + awaited + "]";
	}
}
