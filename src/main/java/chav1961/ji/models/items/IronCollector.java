...
public class IronCollector implements Actor {
	private static AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.IRON, 1),
	...
	public String toString() {
		return "IronCollector [awaited=" + awaited + "]";
	}
}
