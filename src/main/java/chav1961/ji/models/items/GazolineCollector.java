...
public class GazolineCollector implements Actor {
	private static AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.GAZOLINE, 1),
												 new AncestorSourceImpl(GoodsType.RAILWAY, 1)
												};

	private int	awaited = 0;

	public GazolineCollector() {
	}
	...
	public String toString() {
		return "GazolineCollector [awaited=" + awaited + "]";
	}
}
