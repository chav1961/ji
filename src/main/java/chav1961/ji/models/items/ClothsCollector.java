...
public class ClothsCollector implements Actor {
	private static AncestorSource[]	ancestors = {new AncestorSourceImpl(GoodsType.CLOTH, 1),
												 new AncestorSourceImpl(GoodsType.RAILWAY, 1)
												};

	private int	awaited = 0;

	public ClothsCollector() {
	}
	...
	public String toString() {
		return "ClothesCollector [awaited=" + awaited + "]";
	}
}
